...
<body>
    <div class="container">
        ...
        <div class="form-container">
            <h1>✏️ Edit League</h1>
            <p class="subtitle">Update league information</p>
            ...
            <form action="{{ route('admin.leagues.update', $league->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $league->name) }}" required placeholder="e.g., Spring 2026 League">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="season" name="season" value="{{ old('season', $league->season) }}" required placeholder="e.g., Spring 2026">
                    @error('season')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" id="start_date" name="start_date" value="{{ old('start_date', $league->start_date->format('Y-m-d')) }}" required>
                        @error('start_date')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="date" id="end_date" name="end_date" value="{{ old('end_date', $league->end_date->format('Y-m-d')) }}" required>
                        @error('end_date')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="time" id="default_tee_time" name="default_tee_time" value="{{ old('default_tee_time', $league->default_tee_time ? \Carbon\Carbon::parse($league->default_tee_time)->format('H:i') : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="tee_time_interval" name="tee_time_interval" value="{{ old('tee_time_interval', $league->tee_time_interval ?? 8) }}" min="1" max="30" step="1">
                ...
                <div class="form-group">
                    <div class="checkbox-group">
                        <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $league->is_active) ? 'checked' : '' }}>
                        <label for="is_active">League is Active</label>
                    </div>
                    <div class="help-text">Inactive leagues won't show up in the main list</div>
                </div>

                <div class="form-group">
                    <label for="sub_request_code">Sub Request Code</label>
                    <input type="text" id="sub_request_code" name="sub_request_code" value="{{ old('sub_request_code', $league->sub_request_code) }}" placeholder="e.g., golf2026" maxlength="50">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="fee_per_player" name="fee_per_player" value="{{ old('fee_per_player', $league->fee_per_player) }}" step="0.01" min="0" placeholder="e.g., 150.00">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="par3_payout" name="par3_payout" value="{{ old('par3_payout', $league->par3_payout) }}" step="0.01" min="0" placeholder="e.g., 25.00">
                        @error('par3_payout')
                            <div class="error">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px;">
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="number" id="payout_2nd_pct" name="payout_2nd_pct" value="{{ old('payout_2nd_pct', $league->payout_2nd_pct) }}" step="1" min="0" max="100">
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <input type="number" id="payout_3rd_pct" name="payout_3rd_pct" value="{{ old('payout_3rd_pct', $league->payout_3rd_pct) }}" step="1" min="0" max="100">
    ...
    <script>
        ...
        function updateTeeboxes() {
            ...
            const currentTeebox = "{{ old('default_teebox', $league->default_teebox) }}";
